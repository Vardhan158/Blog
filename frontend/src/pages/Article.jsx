...
const styles = {
  section: {
    ...
    padding: "2.5rem 1.5rem", color: "#1e1b4b",
  },
  ...
  h1: { fontSize: "1.75rem", fontWeight: 600, color: "#1e1b4b", lineHeight: 1.25 },
  sub: { fontSize: ".85rem", color: "#64748b", fontWeight: 300, marginTop: ".4rem" },
  searchWrap: { maxWidth: 480, margin: "0 auto 2.5rem", position: "relative" },
  searchIcon: { position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "#94a3b8", fontSize: 14 },
  searchInput: {
    width: "100%", border: "1px solid #e2e8f0", borderRadius: 40,
    padding: "10px 16px 10px 42px", fontFamily: "'Poppins', sans-serif",
    fontSize: ".85rem", color: "#1e1b4b", background: "#fff", outline: "none",
  },
  ...
  cardTitle: { fontSize: ".95rem", fontWeight: 600, color: "#1e1b4b", lineHeight: 1.35, flex: 1, textDecoration: "none" },
  likeBtn: { display: "flex", alignItems: "center", gap: 4, background: "none", border: "none", cursor: "pointer", padding: 0, flexShrink: 0 },
  likeCount: { fontSize: ".75rem", color: "#64748b" },
  excerpt: {
    fontSize: ".775rem", color: "#64748b", lineHeight: 1.65, fontWeight: 300,
  ...
  avatar: {
    width: 22, height: 22, borderRadius: "50%", background: "#ede9fe",
    display: "flex", alignItems: "center", justifyContent: "center",
    fontSize: 10, fontWeight: 600, color: "#6366f1",
  },
  readMore: { fontSize: ".75rem", color: "#6366f1", fontWeight: 500, textDecoration: "none", display: "inline-block", marginTop: ".6rem" },
};
